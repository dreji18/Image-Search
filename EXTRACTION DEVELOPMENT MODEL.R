...
setwd("C:/Users/rejid4996/Desktop/My Projects/Project Theia/Theia Images")  # DIRECTORY SET TO THE REPOSITORY FOLDER
...
capture.output(print(list_data), file = "My New File.txt")

#Module to find list of paths where search keyword and extracted text match
#setwd("/Users/rohith/Desktop/test")
